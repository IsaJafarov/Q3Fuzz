...
class MSGCrafter():
    ...
    def add_ack_frame(self, builder: QuicPacketBuilder, layer: XmlLayer) -> None:
        """
    ...
    def add_stream_frame(self, builder:QuicPacketBuilder, stream_info, h3_frame_payload) -> None:
        """
