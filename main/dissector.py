...
class MSGDissector():
        ...
        for layer in message.layers:
            if layer.layer_name == 'quic':
                ...
                # This HTTP/3 layer has non-HTTP/3 data (QPACK)                
                    ...
                    elif 'QPACK Decoder' in layer.stream_uni or 'qpack_decoder' in layer.field_names: 
    ...
    def _dissect_qpack_decoder_frame(self, layer:XmlLayer) -> QpackDecoder:
        ...
        if 'qpack_decoder' in layer.field_names and layer.qpack_decoder.raw_value is not None:
